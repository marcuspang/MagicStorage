...
namespace MagicStorage.Common.Systems {
	internal partial class MagicRecipes : ModSystem {
		...
		public override void AddRecipeGroups()
		{
			...
			RegisterGroup("MagicStorage:AnyChest", group);
			...
			RegisterGroup("MagicStorage:AnyDiamond", group);
			...
			RegisterGroup("MagicStorage:AnyWorkBench", group);
			...
			RegisterGroup("MagicStorage:AnyPreHmAnvil", group);
			...
			RegisterGroup("MagicStorage:AnyBottle", group);
			...
			RegisterGroup("MagicStorage:AnySink", group);
			...
			RegisterGroup("MagicStorage:AnyTable", group);
			...
			RegisterGroup("MagicStorage:AnyCookingPot", group);
			...
			RegisterGroup("MagicStorage:AnyHmAnvil", group);
			...
			RegisterGroup("MagicStorage:AnyHmFurnace", group);
			...
			RegisterGroup("MagicStorage:AnyBookcase", group);
			...
			RegisterGroup("MagicStorage:AnyTombstone", group);
			...
			RegisterGroup("MagicStorage:AnyCampfire", group);
			...
			RegisterGroup("MagicStorage:AnyToilet", group);
			...
			RegisterGroup("MagicStorage:AnyFishingBobber", group);
			...
			RegisterGroup("MagicStorage:AnyMythrilBar", group);
			...
			RegisterGroup("MagicStorage:AnyDemoniteBar", group);
			RegisterGroupClone(group, nameof(ItemID.DemoniteBar));

			ModLoadingProgressHelper.SetLoadingSubProgressText("");
		}

		private static void RegisterGroup(string name, RecipeGroup group) {
			group.Register();
			RecipeGroup.recipeGroupIDs[name] = group.RegisteredId;
		}
		...
		private static void RegisterGroupClone(RecipeGroup original, string groupName) {
			...
			if (RecipeGroup.recipeGroupIDs.TryGetValue(groupName, out int groupID)) {
				...
				group.ValidItems = original.ValidItems;
				group.DecraftItemId = original.DecraftItemId;
